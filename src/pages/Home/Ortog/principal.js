   ...
   <SafeAreaView style={styles.container}><StatusBar backgroundColor={'#9fa75a'}/>
    <ImageBackground style={styles.img} source={require('../../../../assets/ImagemBase.jpg')} />
      ...
      <View style={styles.all}>
        ...
        <Text style={styles.h1}>Principais Sintomas</Text>
        <Text style={styles.h2}>• Sente a mastigação errada;{'\n'}• Falta de exposição dentária no sorriso;{'\n'}• Dificuldade respiratória;{'\n'}• Dificuldade para se alimentar;{'\n'}• Sorriso gengival;</Text>
        <Image source={require('./../../../../assets/Ortog/sintoma.png')} style={styles.foto}/>
      </View>
    </ScrollView>
